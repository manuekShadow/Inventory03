...
public class Config {
    ...
    public static void cargaConfig(){
        try{
            estaCargada=false;
            logger.info("Ruta Base: " + rutaConf+archivoprops);
            ...
            if(arch.exists()){
                ...
                logger.info("#####Conectado a: " + host+ " #####");
                logger.info("#####Conectado a: " + port+ " #####");
                logger.info("#####Conectado a: " + ms_port+ " #####");
                		
                //System.out.println("#####Conectado a: " + host+ " #####");
                //System.out.println("#####Conectado a: " + port+ " #####");
                //System.out.println("#####Conectado a: " + ms_port+ " #####");
                estaCargada = true;

            }
        }catch(Exception ex){
            logger.info("Excepcion al cargar la configuracion: " + ex.toString());
