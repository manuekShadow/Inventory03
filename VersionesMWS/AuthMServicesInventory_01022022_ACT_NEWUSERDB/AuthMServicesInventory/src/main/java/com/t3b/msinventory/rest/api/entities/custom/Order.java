...
public class Order {
	...
	public Time getHora_envio_nube() {
		return hora_envio_nube;
	}
	public void setHora_envio_nube(Time hora_envio_nube) {
		this.hora_envio_nube = hora_envio_nube;
	}
	public Order(String tclave, Date fecha, Integer folio_conteo, Integer iclave, Integer num_conteo,
			...
			Integer status_conteo, String cb_caja, Integer useq, Time hora_envio_nube) {
		super();
		this.tclave = tclave;
		this.fecha = fecha;
		this.folio_conteo = folio_conteo;
